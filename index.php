...
<head>
    <title>Home - Realtime Reporting System</title>
    <meta name="title" content="home">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Welcome to Realtime Reporting System">
...
<?php
    ...
    <div class="wrapper justify-content-center">
        ...
        <div id="gap" style="height: 5rem"></div>
            ...
            ?> 
            <?php
            require "components/createPostView.php";
            require "components/PostsView.php";
            ?>
        </div>
    </div>
